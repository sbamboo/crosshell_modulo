...
_set = setKeyPath(_set,"SmartInput.Completions.Completer","V1")
...
_set = setKeyPath(_set,"SmartInput.Completions.IncludeCurDir",False)
_set = setKeyPath(_set,"SmartInput.Completions.HideByContext",True)
_set = setKeyPath(_set,"SmartInput.Completions.ColorAliases",True)
...
_set = setKeyPath(_set,"SmartInput.Styling.Options",{"bottom-toolbar":"fg:#181818 bg:#107c41","completion-menu":"bg:#151515 #eeeeee","completion-menu.completion.current":"bg:#2f2f2f"})
_set = setKeyPath(_set,"SmartInput.Styling.Completions",{"cmd":"fg:#b3b4b6","arg":"fg:#5555ff","alias":"fg:cyan","custom":"fg:magenta","dir":"fg:#f4a460","file":"fg:#deb887","script":"fg:#db7093"})
